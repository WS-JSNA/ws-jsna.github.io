...
The map shows the relative deprivation deciles (using national rankings) for LSOAs in NHS Crawley CCG. The most deprived areas (those in the most deprived 10% of LSOAs in England) are shaded dark blue. As can be seen from the map, NHS Crawley CCG contains some of the most deprived neighbourhoods in the country (these fall within the River, Courtwick with Toddington and Bersted wards).

{% include htmlwidget_map html_path="/assets/htmlwidgets/IMDmap_09H.html" %}
...
{% include figure image_path="/assets/images/ccg-profiles/crawley/Population-weighted-using-Jan-2016-HSCIC-release-ID2015-deprivation-score.gif" alt="Population weighted (using Jan 2016 HSCIC release) ID2015 deprivation score" caption="Population weighted (using Jan 2016 HSCIC release) ID2015 deprivation score" class="full" %}

In NHS Crawley CCG, all of the GP practices are amongst the 20% least deprived in the country.

The table below shows the number of practices in each deprivation decile for NHS Crawley CCG, and other CCGs in West Sussex.
...
{% include htmlwidget_map html_path="/assets/htmlwidgets/Incomemap_09H.html" %}
...
The map below shows the relative income deprivation affecting children deciles (using national rankings) for LSOAs in NHS Crawley CCG.

{% include htmlwidget_map html_path="/assets/htmlwidgets/IDACImap_09H.html" %}
...
The map below shows the relative income deprivation affecting older people deciles (using national rankings) for LSOAs in NHS Crawley CCG.

{% include htmlwidget_map html_path="/assets/htmlwidgets/IDAOPImap_09H.html" %}
...
{% include htmlwidget_map html_path="/assets/htmlwidgets/Empmap_09H.html" %}
...
{% include htmlwidget_map html_path="/assets/htmlwidgets/Edumap_09H.html" %}
...
{% include htmlwidget_map html_path="/assets/htmlwidgets/Healthmap_09H.html" %}
...
{% include htmlwidget_map html_path="/assets/htmlwidgets/Crimemap_09H.html" %}
...
{% include htmlwidget_map html_path="/assets/htmlwidgets/Barriersmap_09H.html" %}
...
The map below shows the relative living environment deprivation deciles (using national rankings) for LSOAs in NHS Crawley CCG. The most deprived areas (those in the most deprived 10% of LSOAs in England) are shaded dark blue.

{% include htmlwidget_map html_path="/assets/htmlwidgets/Livmap_09H.html" %}
...
The map below shows the proportion of households at Lower-layer super output area level in NHS Crawley that were identified as deprived on **at least one** measure of deprivation from the 2011 Census. Darker areas indicate a higher proportion of deprived households.

{% include figure image_path="/assets/images/ccg-profiles/crawley/Crawley-Census-households-with-at-least-one-deprivation-indicator.jpg" alt="HH_CWS_atleast1_Dep_Census" caption="Proportion of households at LSOA in Crawley CCG deprived on at least one measure of deprivation - 2011 census" %}

The map below shows the proportion of households at Lower-layer super output area level in NHS Crawley that were identified as deprived on **three or four** measures of deprivation from the 2011 Census. Darker areas indicate a higher proportion of deprived households. Using the census 2011 groupings these represent the most deprived areas in the Crawley CCG region.

{% include figure image_path="/assets/images/ccg-profiles/crawley/Crawley-Census-households-with-three-or-four-deprivation-indicators.jpg" alt="HH_CWS_3_4_Dep_Census" caption="NHS Crawley CCG - Proportion of Households identified as deprived on three or four census deprivation indicators." %}
...
In 2013, **12.1%** of children under the age of 16 years in West Sussex were living in low income households. Within Crawley CCG area, the proportion of children living in low income households was **16.8%** – significantly higher than West Sussex county.

The table below shows the number and proportion of children under 16 years of age living in low income households in local authority districts of NHS Crawley CCG between 2008 and 2013. It should be noted that the data for Horsham reflects the whole district of Horsham and not just the part of Horsham that is designated as NHS Crawley CCG.

#### Percentage of children under 16 years living in low income households: local authorities covering Crawley CCG (2008-13)

| Area | 2008 | 2009 | 2010 | 2011 | 2012 | 2013 |
| Crawley | 3,775 (18.7%) | 4,090 (19.5%) | 4,165 (19.5%) | 4,165 (19.0%) | 3,900 (17.4%) | 3,810 (16.8%) |
